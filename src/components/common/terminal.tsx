    ...
    <>
      <div className="mb-10">
        <h2 className="text-2xl lg:text-4xl text-white">
          Experience | <span className="text-[#3b82f6]">Education</span>
        </h2>
      </div>
      <div
      ...
      >
            ...
            <div className="flex flex-row h-[45px] bg-[#14151b] w-full">
              <div className="flex flex-row items-end w-full">
                <div className="flex flex-col items-center">
                  <div className="flex flex-row relative justify-between items-center ml-[10px] relative bg-[#212029] w-[150px] lg:w-[250px] h-[30px] transition-all py-[19px] px-3 rounded-t-lg">
                    <div className="flex flex-row items-center justify-center gap-2">
                      <BsTerminal className="text-[14px]" />
                      <h4 className="text-[12px] hidden lg:block">
                        Windows PowerShell
                      </h4>
                      <h4 className="text-[12px] block lg:hidden">
                        PowerShell
                      </h4>
                    </div>
                    <button
              ...
              <div className="flex flex-row">
                <button
                  onClick={() => setMinimizeTerminal(true)}
        ...
        {minimizeTerminal && (
          ...
          >
            <div
              className="flex flex-row items-center justify-center gap-1 p-2 w-full h-full"
              onClick={() => {
                open();
