  ...
  return (
    <>
      <div className="flex flex-col relative h-[80px] mt-40">
        ...
        <Link
          to={"/resume"}
          className="absolute flex flex-col justify-center -top-[40px] left-[80px] flex flex-col border-2 border-[#3b82f6] bg-[#3b82f6]/10 backdrop-blur-3xl h-[80px] rounded-[80px] w-[75%] sm:max-w-[350px] cursor-pointer p-3 transition-shadow duration-300 hover:shadow-[0_0_50px_6px_rgba(59,130,241,0.5),_inset_0_0_35px_10px_rgba(59,130,241,0.4)]"
        >
          {children}
        </Link>
      </div>
...
export const LineVerticalRight = ({
  children,
}: {
    ...
    <>
      <div className="flex flex-col min-h-[70vh] relative mt-[18px] pb-40">
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(to bottom, #00df56,#a71900, #5f00b800)",
          }}
        />
        {children}
      </div>
