    ...
    return (
        <>
            <button onClick={toggleActive}
                    className="flex items-center justify-center w-[45px] text-xl  hover:bg-white/5"><FaRegSquare
            ...
            >
                ...
                <div
                    className="flex flex-col w-[98%] h-[98%] transition-all  border border-neutral-800 rounded-lg overflow-hidden">
                    <div className="flex flex-row -h-[45px] bg-[#14151b] w-full">
                        <div className="flex flex-row items-end w-full">
                            <div className="flex flex-col items-center">
                                <div
                                    className="flex flex-row justify-between items-center ml-[10px] relative bg-[#212029] w-[150px] lg:w-[250px] h-[30px] transition-all  py-[19px] px-3 rounded-t-lg">
                        ...
                        <div className="flex flex-row ">
                            <button
                                onClick={() => {toggleActive(); if (minimize) minimize() }}
                            ...
                            <button onClick={toggleActive}
                                ...
                                <FaRegSquare className="text-[12px]"/></button>
                            <button
                                onClick={toggleActive}
